    ...
    <div class="mint-flex-1 mint-py-8">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
        <div class="flex flex-col">
          <a href="/single-provider-integrations/motor-insurance" class="text-indigo-600 hover:underline font-medium not-prose">Motor
            Insurance</a>
          <p class="text-sm text-gray-600 mt-1">Seamless insurance for the cars you're selling and the drivers that are
            buying from you.</p>
        </div>
        <div class="flex flex-col">
          <a href="/single-provider-integrations/sme-medical-insurance" class="text-indigo-600 hover:underline font-medium not-prose">SME
            Medical Insurance</a>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
        <div class="flex flex-col">
          <a href="/price-comparison/motor-insurance" class="text-indigo-600 hover:underline font-medium not-prose">Motor
            Insurance</a>
          <p class="text-sm text-gray-600 mt-1">Retrieve and compare comprehensive and TPL motor quotes from multiple
            providers.</p>
        </div>
        <div class="flex flex-col">
          <a href="/price-comparison/property" class="text-indigo-600 hover:underline font-medium not-prose">Property
            Insurance</a>
