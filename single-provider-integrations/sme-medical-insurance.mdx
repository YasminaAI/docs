...
description: 'Issue SME medical insurance policies for a company’s employees and collect their health declarations.'
icon: 'users-medical'
---

### Overview
This guide walks you through integrating Yasmina’s Medical Insurance API into your platform (for Multiple Insurance Providers with package comparison, [click here](/multi-provider-integrations/sme-medical-insurance)).
...
The API takes three fields. The company_id as referenced above, the insurance_provider (`medgulf` for this integration), and an array called insured. The insured are the employees that the company wants to issue insurance for.
