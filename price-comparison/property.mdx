...
## Prerequisites
1. **Account in Yasmina** - See the <a href="/introduction#onboarding" target="_blank">Onboarding section</a> for details.  You need to add "Property (Price Comparison)" in the products field.
