...
This call exists for the embed only. A server-to-server integration uploads photos against the selected quote with [Upload Vehicle Photos](/car-api-reference/quote-requests/upload-vehicle-photos) instead.
