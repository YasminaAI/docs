...
Once the payment succeeds the policy is issued: it gets a policy number from the provider and a policy schedule listing every member, which you can download through the [List policies API](/medical-api-reference/policies/list-policies).
